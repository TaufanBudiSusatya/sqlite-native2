package com.example.sqlite_taufan
...
import com.example.sqlite_taufan.db.UserEntity
...
class MainActivity : AppCompatActivity(), RecyclerViewAdapter.RowClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*
        memberikan perintah pada button save
        maka akan meng-inputkan nama,email,nohhp atau phone
         */
